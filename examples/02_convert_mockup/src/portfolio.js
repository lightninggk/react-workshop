                    ...
                    <div className="small-12 medium-8 large-6 columns">
                        <div className="nav-bar">
                            <ul className="button-group">
                                <li><a href="#" className="button">About</a></li>
                                <li><a href="#" className="button">Work</a></li>
                ...
                <div className="row contact">
                    ...
                    <div className="large-12 columns">
                        ...
                        <div className="large-4 columns">
                            <strong>Email</strong>: <a href="http://foundation.zurb.com/templates/portfolio-theme.html#">me@myportfolio.com
                        </a>
                        </div>
                        <div className="large-4 columns">
